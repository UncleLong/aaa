...
function Confirm(g) {
    ...
    if (g == "u") {
        $(".ReleaseFaile p").html("Redeem this promotion code? If you click confirm, your code will be used even if you do not finalize the order.");
        ...
        $(".ReleaseFaile p").html("Your order will be cancelled if you leave");
        $(document).one("click", ".FaileSure", function () {
            $(".confirm").fadeOut(function () {
